...
public class QuizResultController {
    ...
    public QuizResult insertClassDetails(@RequestBody QuizResult classDetails) {
        ...
        Optional<QuizResult> data = classDetailsRepository
                .findByIdNumberAndClassNameAndClassNumber(
                        classDetails.getIdNumber(),
                        classDetails.getClassName(),
                        classDetails.getClassNumber()
                );

       // System.out.println("Incoming Data: " + classDetails.toString());
